  ...
  return (
    <div ref={containerRef} suppressHydrationWarning>
      ...
      <div className={styles.introTextContainer} suppressHydrationWarning>
        <div className={`${styles.introText} gsap-intro-1`} suppressHydrationWarning>Hi.</div>
        <div className={`${styles.introText} gsap-intro-2`} suppressHydrationWarning>My name is Omar Gamal.</div>
        <div className={`${styles.introText} gsap-intro-3`} suppressHydrationWarning>I craft digital experiences.</div>
      </div>
    </div>
  );
}
